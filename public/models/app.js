...
function displayWeightExercise() {
    $.getJSON("/weights/", function (data) {
        for (let i = 0; i < data.length; i++) {
            ...
            $("#weightCard" + i).append(`<div class="card-footer"><button class="updateBtn"><strong>Update</strong></button><button class="deleteBtn" data-id=${data[i]._id}><strong>Delete</strong></button></div>`)
...
function displayCardioExercise() {
    $.getJSON("/cardio", function(data) {
        for(let i=0; i<data.length; i++){
            ...
            $("#cardioCard" + i).append(`<div class="card-footer"><button class="updateBtn"><strong>Update</strong></button><button class="deleteBtn" data-id=${data[i]._id}><strong>Delete</strong></button></div>`)
